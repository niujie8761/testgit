<?php
/**
 * FixedCostStrategyController.php
 *
...
class FixedCostStrategyController   extends CostStrategyController
{
    public function actionCost(LessonController $lesson)
    {
        return $lesson->actionGetDuration() * 5;
